  	  ...
  	  read :
  	    begin
  	       ...
  	       if (test_addr_mem1 == 4'h0)
  		      ...
  		      begin
  		    	 error_counter_o <= error_counter_o + 1;
  		    	 $error("\033[0;31mError!\033[0m: test_rdata_mem1111 should be %h, got %h, not returning the last read value\n", 8'ha5, test_rdata_mem1);
  	       	      end
  	       	 end
  	    end
  	  write_read : 
  	    begin
  	       ...
  	       if (test_wdata_mem1 == test_rdata_mem1 && test_rdata_mem1 != 8'ha5)
  		 begin//
  		    error_counter_o <= error_counter_o + 1;
  		    $error("\033[0;31mError!\033[0m: test_rdata_mem1 should be returning %h, got %h,not returning write of same CC\n", test_wdata_mem1, test_rdata_mem1);
  		 end
  	    end
  	  done :
  	    $finish;
