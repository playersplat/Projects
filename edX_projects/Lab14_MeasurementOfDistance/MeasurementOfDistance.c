...
int main(void) {
    // Initial setup functions
		ADC0_Init();
    ST7735_InitR(INITR_GREENTAB); // Initialize ST7735 LCD
		ST7735_FillScreen(ST7735_BLACK);
		ST7735_SetCursor(5, 5);
	  ST7735_OutString("Hello"); // Display the converted string
		     // Initialize ADC
...
if(Flag == 1){
            ...
            ST7735_SetCursor(5, 10); // Adjust as needed for your display layout
            ST7735_OutString((char *)String); // Display the converted string
        }
    }
}
