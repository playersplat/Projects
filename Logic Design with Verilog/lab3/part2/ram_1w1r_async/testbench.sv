  	...
  	case (state)
  	  ...
  	  write_read : 
  	    begin
  		 ...
  		 begin
  		    error_counter_o <= error_counter_o + 1;
  		    $error("\033[0;31mError!\033[0m: test_rdata_mem1 should be %h, got %h, not returning write of same CC\n", test_wdata_mem1, test_rdata_mem1);
  		 end
  	    end
  	  read :
  	    begin
  	       test_addr_mem1  <= test_addr_mem1 + 1;
  	       if (test_rdata_mem1 != (test_rdata_mem1_reg ^ 8'hff) )
  		 begin
  		    error_counter_o <= error_counter_o + 1;
...
`endif
      ...
      $display(" /_  __/__  _____/ /_/ /_  ___  ____  _____/ /_     _________ _____ ___      <  /      _<  /____ ____ ________  ______  _____");
      $display("  / / / _ \\/ ___/ __/ __ \\/ _ \\/ __ \\/ ___/ __ \\   / ___/ __ `/ __ `__ \\     / / | /| / / / ___// __ `/ ___/ / / / __ \\/ ___/");
      $display(" / / /  __(__  ) /_/ /_/ /  __/ / / / /__/ / / /  / /  / /_/ / / / / / /    / /| |/ |/ / / /   / /_/ (__  ) /_/ / / / / /__  ");
      $display("/_/  \\___/____/\\__/_.___/\\___/_/ /_/\\___/_/ /_/  /_/   \\__,_/_/ /_/ /_/____/_/ |__/|__/_/_/____\\__,_/____/\\__, /_/ /_/\\___/  ");
