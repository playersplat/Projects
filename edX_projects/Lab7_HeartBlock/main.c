...
//   Global Variables
#define AS    (*((volatile unsigned long *)0x40025040)) //Input from PF4 --> AS
#define READY (*((volatile unsigned long *)0x40025020)) //Output to PF3
#define VT      (*((volatile unsigned long *)0x40025008)) //Output to PF1
unsigned long SW1; 
...
unsigned long i;
  ...
  time = 7500 * msec;  // Approx 100ms delay at 80MHz
  while(time){
    time--;
  }
